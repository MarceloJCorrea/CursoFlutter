...
class OrdersBloc extends BlocBase {
  ...
  void _addOrdersListener(){
    _firestore.collection("orders").snapshots().listen((snapshot){
      ...
      _sort();//dou o sort e depois exibo na tela, dentro da função
    });
  }

  void setOrderCriteria(SortCriteria criteria){
    _criteria = criteria;//setou o criterio
    _sort();//chamou a função de ordenação
  }

  void _sort(){
    switch(_criteria){//ordenar de forma opostas
    ...
    _ordersController.add(_orders); //depois de ordenar adiciona as orders
  }
